      ...
      <div class="header-right">
        ...
        <nav class="nav-menu">
          ...
          <div class="dropdown">
            <span class="nav-link dropdown-toggle" @click="toggleGenreDropdown">
              Thể loại
              <i class="fas fa-caret-down genre-toggle-icon" :class="{ 'rotate': showGenreDropdown }"></i>
            </span>
            <div v-if="showGenreDropdown" class="dropdown-menu">
              <router-link to="/the-loai/ngontinh" class="dropdown-item">Ngôn Tình</router-link>
              <router-link to="/the-loai/kiemhiep" class="dropdown-item">Kiếm Hiệp</router-link>
              <router-link to="/the-loai/kinhdi" class="dropdown-item">Kinh Dị</router-link>
              <router-link to="/the-loai/khoahocvientuong" class="dropdown-item">Khoa Học Viễn Tưởng</router-link>
              <router-link to="/the-loai/dammy" class="dropdown-item">Đam Mỹ</router-link>
            </div>
          </div>
          ...
          <router-link to="/truyen-viet" class="nav-link">Truyện Việt</router-link>
          <router-link to="/truyen-hot" class="nav-link">Truyện Hot</router-link>
        </nav>
        ...
        <div v-if="isLoggedIn" class="user-menu">
          ...
          <div class="avatar-wrapper" @click="toggleDropdown">
            <img :src="avatarUrl" alt="User Avatar" class="user-avatar" @error="handleAvatarError" />
            <i class="fas fa-caret-down dropdown-toggle-icon" :class="{ 'rotate': showDropdown }"></i>
          </div>
...
export default {
  ...
  setup() {
    ...
    const userFullName = computed(() => authStore.user?.full_name || "Người dùng");
...
.user-dropdown .dropdown-item:hover {
  background: linear-gradient(90deg, rgba(76, 175, 80, 0.2) 0%, rgba(255, 215, 0, 0.2) 100%);
  color: #ffffff;
  box-shadow: 0 0 10px rgba(76, 175, 80, 0.3);
...
.user-dropdown .logout:hover {
  background: linear-gradient(90deg, rgba(211, 47, 47, 0.2) 0%, rgba(255, 85, 85, 0.2) 100%);
  color: #ff5555;
